...
public class Main {
    public static void main(String[] args) {
        ...
        nameList.add("Cecíl");
        nameList.add("Géza");
        System.out.println(getNameList(nameList));
    ...
    public static int getChangeLetters(String input) {
        ...
        for (char ch : input.toCharArray()) {
            ...
            maxFrequent = Math.max(maxFrequent, letterFrequent.get(ch));
        }
        return input.length() - maxFrequent;
    }
    ...
    // Task 2:
    public static Set<String> getNameList(List<String> list) {
