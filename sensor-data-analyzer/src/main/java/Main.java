...
public class Main {
    public static void main(String[] args) {
        JsonExporterStrategy jsonExporterStrategy = new JsonExporterStrategy();
        CsvExporterStrategy csvExporterStrategy = new CsvExporterStrategy();
        ...
        csvExporterStrategy.fileExporter(list, "CsvExporting.csv");
        jsonExporterStrategy.fileExporter(list, "JsonExporting.json");
    }
}